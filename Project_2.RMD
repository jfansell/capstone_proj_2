...
```
The model provides reasonable out of the box performance - an accuracy rate of just beneath 60%. For an LDA model there is no opportunity to tune it further.

```{r Collect results, clear environment, warning=FALSE, include=FALSE}
